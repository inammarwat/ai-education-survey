...
```{r hist_ai_knowledge_interactive, echo = FALSE, message = FALSE, warning = FALSE}
# ---------------------------------------------------------------------------
...
g <- ggplot(
  ...
  labs(
    ...
    subtitle = "Most students report moderate AI knowledge (scores 4–7); few consider themselves experts.",
...
edu_melt <- survey_data %>%
  ...
  arrange(desc(mean_rating))      # order bars high → low
...
ggplot(edu_melt, aes(x = reorder(Aspect, mean_rating), y = mean_rating,
  ...
  labs(
    ...
    y        = "Average Likert Rating (1 = Strongly Disagree … 5 = Strongly Agree)",
...
ggplot(
  ...
  labs(
    title    = "Where Do Students Expect AI to Make the Biggest Impact?",
...
knitr::kable(
  ...
  caption = "Table 2  Perceptions by Knowledge Level"
)
```
...
ggplot(
  ...
  labs(
    ...
    subtitle = paste(
      "Students with higher self‑reported AI knowledge rate Learning and",
      "Teaching aspects more positively, while concerns about",
      "Disadvantages persist across all groups."
    ),
    x    = "Perception Aspect",
    y    = "Average Likert Rating (1 = Strongly Disagree … 5 = Strongly Agree)",
    fill = "Knowledge Level"
