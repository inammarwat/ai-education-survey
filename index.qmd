...
# Add both subtitle and caption as annotations
ggplotly(p) |>
  layout(
    annotations = list(
      list(
        x = 0.3,
        y = 1.03,
        text = "STEM‑oriented students give far more top (8–10) utility scores than their statistics‑focused peers, highlighting a clear major‑based optimism gap.",
        xref = "paper",
        yref = "paper",
        xanchor = "center",
        yanchor = "bottom",
        showarrow = FALSE,
        font = list(size = 13, color = "gray20", family = "Arial")
      ),
      list(
        x = 1.2,
        y = 0.15,
        text = "Data source: Kaggle — (Petrascu 2023)",
        showarrow = FALSE,
        xref = "paper",
        yref = "paper",
        xanchor = "right",
